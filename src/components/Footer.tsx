        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center mb-4">
              <img src="https://i.ibb.co/fzY2Lh4J/t-logo.png" alt="Trezor Logo" className="h-8 w-auto" />
              <span className="ml-2 text-xl font-bold text-white">Trezor</span>
            </div>
            <p className="text-gray-400 mb-4">
              The original and most trusted hardware wallet for secure crypto storage.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Compare Models</a></li>
            </ul>
          </div>
